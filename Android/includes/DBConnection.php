  ...
  <div class="user-container container-fluid ng-scope" ng-controller="UserController as user">
    ...
    <div class="container-fluid">
        ...
        <div class="row visible-xs" style="line-height:30px;">
            <div class="col-md-12">
                <div class="pull-left" style="line-height: 54px;" ng-show="&#39;000webhost&#39; == config.theme"><img class="logo" src="./DBConnection_files/logo.png" alt="logo" title="000webhost" height="34px"></div>
    ...
    <!-- ngRepeat: (key, dir) in fileNavigator.currentPath track by key --><li ng-repeat="(key, dir) in fileNavigator.currentPath track by key" ng-class="{&#39;active&#39;:$last}" class="animated fast fadeIn ng-scope">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 hidden-xs">
                <img class="pull-left logo" src="./DBConnection_files/logo.png" alt="logo" title="000webhost" ng-show="&#39;000webhost&#39; == config.theme">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <img id="imagepreview-target" class="preview" alt="DBConnection.php" ng-class="{&#39;loading&#39;: apiMiddleware.apiHandler.inprocess}">
  ...
  <div ng-show="temps.length &gt; 1 &amp;&amp; showDetails" class="ng-scope ng-hide">
    <ul class="selected-file-details">
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        <b class="ng-binding">DBConnection.php</b>
      ...
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        ...
        <div class="detail-sources">
          <div class="like-code mr5 ng-binding">
            <b class="ng-binding">Destination:</b> /public_html/Android/includes/DBConnection.php
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="rename()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              <label class="radio ng-binding">Enter new name for <b class="ng-binding">DBConnection.php</b></label>
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <div ng-hide="config.allowedActions.compressChooseName" class="ng-binding ng-hide">
                    Are you sure to compress <b class="ng-binding">DBConnection.php</b> ?
                  </div>
    ...
    <div class="modal-content">
        <form ng-submit="extract()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <label class="radio ng-binding">Enter the folder name for the extraction of <b class="ng-binding">DBConnection.php</b></label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form ng-submit="edit()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
                <label class="radio bold ng-binding">/public_html/Android/includes/DBConnection.php</label>
                <span class="label label-warning ng-binding ng-hide" ng-show="apiMiddleware.apiHandler.inprocess">Loading ...</span>
                <div id="code-editor" ui-ace="{
                    require: [&#39;ace/ext/language_tools&#39;,&#39;ace/ext/modelist&#39;],
                      ...
                      mode: codeEditor.mode}" ng-model="singleSelection().tempModel.content" ng-show="!apiMiddleware.apiHandler.inprocess" class="ng-pristine ng-untouched ng-valid ace_editor ace-chrome ng-not-empty"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; left: -100px;"></textarea><div class="ace_gutter" aria-hidden="true"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 378.781px; width: 47px;"><div class="ace_gutter-cell " style="height: 14.3906px;">1</div><div class="ace_gutter-cell " style="height: 14.3906px;">2</div><div class="ace_gutter-cell " style="height: 14.3906px;">3<span class="ace_fold-widget ace_start ace_open" style="height: 14.3906px;"></span></div><div class="ace_gutter-cell " style="height: 14.3906px;">4</div><div class="ace_gutter-cell " style="height: 14.3906px;">5</div><div class="ace_gutter-cell " style="height: 14.3906px;">6</div><div class="ace_gutter-cell " style="height: 14.3906px;">7<span class="ace_fold-widget ace_start ace_open" style="height: 14.3906px;"></span></div><div class="ace_gutter-cell " style="height: 14.3906px;">8</div><div class="ace_gutter-cell " style="height: 14.3906px;">9</div><div class="ace_gutter-cell " style="height: 14.3906px;">10</div><div class="ace_gutter-cell " style="height: 14.3906px;">11<span class="ace_fold-widget ace_start ace_open" style="height: 14.3906px;"></span></div><div class="ace_gutter-cell " style="height: 14.3906px;">12</div><div class="ace_gutter-cell " style="height: 14.3906px;">13</div><div class="ace_gutter-cell " style="height: 14.3906px;">14</div><div class="ace_gutter-cell " style="height: 14.3906px;">15<span class="ace_fold-widget ace_start ace_open" style="height: 14.3906px;"></span></div><div class="ace_gutter-cell " style="height: 14.3906px;">16</div><div class="ace_gutter-cell " style="height: 14.3906px;">17</div><div class="ace_gutter-cell " style="height: 14.3906px;">18</div><div class="ace_gutter-cell " style="height: 14.3906px;">19</div><div class="ace_gutter-cell " style="height: 14.3906px;">20</div><div class="ace_gutter-cell " style="height: 14.3906px;">21</div><div class="ace_gutter-cell " style="height: 14.3906px;">22</div></div><div class="ace_gutter-active-line" style="top: 0px; height: 14.3906px;"></div></div><div class="ace_scroller" style="left: 47px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 821px; height: 378.781px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 540px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:14.390625px;top:0px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_support ace_php_tag">&lt;?php</span> </div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px">    <span class="ace_keyword">class</span> <span class="ace_identifier">DbConnect</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">private</span> <span class="ace_variable">$con</span>; </div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">function</span> <span class="ace_identifier">__construct</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">function</span> <span class="ace_identifier">connect</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">include_once</span> <span class="ace_support ace_function">dirname</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_language">__FILE__</span><span class="ace_paren ace_rparen">)</span> .<span class="ace_string">"/constants.php"</span>;</div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable">$this</span><span class="ace_keyword ace_operator">-&gt;</span><span class="ace_identifier">con</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword">new</span> <span class="ace_support ace_class">mysqli</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">DB_HOST</span>, <span class="ace_identifier">DB_USER</span>, <span class="ace_identifier">DB_PASSWORD</span>, <span class="ace_identifier">DB_NAME</span><span class="ace_paren ace_rparen">)</span>;</div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">if</span><span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">mysqli_connect_errno</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">))</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">echo</span> <span class="ace_string">"Failed to connect with database"</span>; </div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">return</span> <span class="ace_variable">$this</span><span class="ace_keyword ace_operator">-&gt;</span><span class="ace_identifier">con</span>; </div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px"><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px">    <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height:14.390625px"><div class="ace_line" style="height:14.390625px">     <span class="ace_support ace_php_tag">?&gt;</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="left: 4px; top: 0px; width: 6.69763px; height: 14.3906px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 15px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 15px; height: 316.594px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 15px; left: 47px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 15px; width: 828px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div></div>
                <!-- ngInclude: --><div ng-include="" data-src="&#39;error-bar&#39;" class="clearfix ng-scope">
  <div class="label label-danger error-msg pull-left animated fadeIn ng-scope ng-hide" ng-show="apiMiddleware.apiHandler.error">
    <i class="glyphicon glyphicon-remove-circle"></i>
    <span class="ng-binding"></span>
...
<li ng-show="config.allowedActions.remove" class="ng-scope">
    ...
    <div class="row login-page ng-hide" ng-hide="user.status">
      <div class="col-md-4 col-md-offset-4">
        <h3><img src="./DBConnection_files/logo-colored.svg" class="logo" alt="logo" ng-show="&#39;000webhost&#39; == user.config.theme">File Manager</h3>
